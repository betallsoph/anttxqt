...
/** Stable hash (sorted keys) for expectedHash guard. */
...
/** Deep-merge for update_section mode="merge". Arrays are replaced, not concatenated. */
...
/** Strip empty strings from every keyFeatures* field (required for Project). */
