                            ...
                            <div className="p-4 sm:p-6 space-y-4">
                                <div className="space-y-4">
                                    {(data.experiences || []).map((exp, index) => (
                                        <div
                                            key={index}
                                            className={`border border-zinc-200 rounded-lg bg-zinc-50/50 p-3 sm:p-4 space-y-3 transition-all duration-200 ${exp.hidden ? "opacity-75 bg-zinc-100" : ""}`}
                                        >
                        ...
                        <div className="border-2 border-black rounded-lg bg-white overflow-hidden shadow-secondary">
                            ...
                            <div className="space-y-3 sm:space-y-4">
                                {data.skillCategories.map((category, catIndex) => (
                                    <div key={catIndex} className="border border-zinc-200 rounded-lg bg-zinc-50/50 p-3 sm:p-4 space-y-3">
                                        <div className="flex justify-between items-center gap-2">
                                            <MoveButtons
                                                index={catIndex}
                        ...
                        <div className="border-2 border-black rounded-lg bg-white overflow-hidden shadow-secondary">
                            ...
                            <div className="space-y-2 sm:space-y-3">
                                {data.links.map((link, index) => (
                                    <div key={index} className="border border-zinc-200 rounded-lg bg-zinc-50/50 p-3 space-y-2">
