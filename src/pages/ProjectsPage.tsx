                            ...
                            <div className="p-6">
                                ...
                                <div className="flex flex-wrap gap-2 mb-3">
                                    {project.tags.map((tag) => (
                                        <span
                                            key={tag}
                                            className="px-3 py-1 text-xs font-semibold bg-zinc-100 border border-zinc-300 rounded-full"
                                        >
                                            {tag}
                                        </span>
                                    ))}
                                ...
                                <div>
                                    <span
                                        className={`px-2 py-0.5 text-xs font-bold border rounded-full ${statusStyles[project.status]}`}
                                    >
                                        {project.status}
                                    </span>
                                </div>
